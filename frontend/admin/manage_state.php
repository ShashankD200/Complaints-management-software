...
<body>
                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center mb-2">
                            <div class="col-sm-6 col-12 mb-2">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight">Manage State</h1>
                            </div>
                            <!-- Actions -->
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <?php
                                                    ...
                                                    $stmt="SELECT count(id) FROM `state_table` 
                            ...
                            <table class="table table-hover table-nowrap" id="myTable"
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th style="font-size: 14px;">state Name</th>
                                ...
                                <tbody style="border: 0px solid black !important;">
                                    <?php
                                        ...
                                        if ($result){
                                                ...
                                                while ($row = mysqli_fetch_array($data)){
                                    ?>
                                    <tr id="stateRow<?php echo $row['id']; ?>">
                                        <!-- DO not change the order because we are editing based on order.. -->
                                        ...
                                        <td class="d-flex p-1 gap-2">
                                            ...
                                            <form action="../../backend/admin/delete_state.php" method="post" onsubmit="return confirm_delete()">
                                                <input type="text" hidden name="update_state_id" class="d-none" value="<?php echo $row['id']; ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addstateLabel">New state</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="px-sm-5" action="../../backend/admin/new_state.php" method="post"
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="addstateLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addstateLabel">Edit State Details</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="px-sm-5" action="../../backend/admin/update_state_details.php" method="post"
                    enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="mb-2">
                            <label for="name" class="form-label">Name <span
                        ...
                        <input type="number" name="update_state_id" hidden readonly id="update_state_id">
                    </div>
    ...
    <script>
        function showEditModal(id) {
            let stateRow = document.getElementById('stateRow' + id);

            let stateName = stateRow.children[1].innerText;

            document.getElementById('update_state_id').value = id;
            document.getElementById('update_name').value = stateName;
        ...
        document.getElementById('manage_state').classList.add('active');
    </script>
