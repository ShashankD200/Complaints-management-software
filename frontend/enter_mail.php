    ...
    <style>
        * {
        ...
        .container::before {
            ...
            height: 2000px;
            border-radius: 50%;
            /* background: linear-gradient(-45deg, #3E497A, #3E497A); */
            background: #03305D;
            right: 48%;
...
<div id="loader" class="center"></div>
    <div class="container">
        <div class="container__forms">
            <div class="form">
                <form action="../backend/login_signup/create_token.php" onsubmit="return showloader()" method="post" class="form__sign-in">
                    ...
                    <div class="new-user-box">
                        <a type="button" href="./login.php" id="btn1">Login</a>
                    </div>

                </form>

                <form action="../backend/login_signup/sign_up.php" method="post" class="form__sign-up">
                    <h2 class="form__title">Forgot Password</h2>
                    <div class="form__input-field">
                        <i class="fas fa-user"></i>
                    ...
                    <div class="form__input-field">
                        ...
                        <input type="emial" placeholder="Email" name="email" required />
                    </div>
                    <div class="form__input-field">
                        <i class="fas fa-phone"></i>
                        <input type="tel" minlength="10" placeholder="Phone" name="phone" required />
                    </div>
                    <div class="form__input-field">
                    ...
                    style="background-color: #FF3859; border: 0px;" value="Sign Up" />
        ...
        <div class="container__panels">
            <div class="panel panel__left">
                <div class="panel__content">
                    <h3 class="panel__title" style="color: white;">Forgot Your Password ?</h3>
