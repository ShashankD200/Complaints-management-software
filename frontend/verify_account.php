...
<body>
    <div class="container">
        <div class="container__forms">
            <div class="form">
                <form action="../backend/login_signup/verify_account.php" method="post" class="form__sign-in">
                    <h6 class="form__title">Verify Account</h6>
        ...
        <div class="container__panels">
            <div class="panel panel__left">
                <div class="panel__content">
                    <h3 class="panel__title" style="color: black;">Verify Account</h3>
                    <p class="panel__paragraph" style="color: black;">
                        Please use the 4 digit code mailed to you on <?php echo $_SESSION['user_email'];?>
                    </p>
                </div>
            </div>
        </div>
